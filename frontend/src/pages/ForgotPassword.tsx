...
export default function ForgotPassword() {
    ...
    return (
        <Layout>
            <Seo
                title="ForgotPassword - Job Market Analyzer"
                description="ForgotPassword to your account on Job Market Analyzer to access personalized features and take full advantage of AI-powered job market insights."
