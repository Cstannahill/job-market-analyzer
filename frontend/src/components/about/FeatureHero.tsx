    ...
    return (
        <>
            <div className="mx-auto relative z-10 text-center">
                <motion.h1
                    className="text-4xl nf-mono sm:text-5xl font-bold mb-4 bg-gradient-to-r from-chart-1 via-chart-3 to-chart-2 bg-clip-text text-transparent"
            ...
            <div className="absolute -bottom-48 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-gradient-to-r from-chart-1 via-chart-3 to-chart-5 opacity-25 blur-[140px] rounded-full" />
        </>
    )
};
